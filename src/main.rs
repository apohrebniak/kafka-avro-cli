...
fn match_args() -> ArgMatches {
    App::new("Kafka Avro CLI")
        ...
        .arg(Arg::new("ssl-ca-location")
            ...
            .multiple(false)
            .required(false))
        .arg(Arg::new("ssl-keystore-location")
            ...
            .multiple(false)
            .required(false))
        .arg(Arg::new("ssl-keystore-password")
